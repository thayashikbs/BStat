...
### 自作関数
同様な処理を繰り返し行う場合は, 関数を作っておくと便利である.
```
# 自作関数の作成
...
Rでは, データ構造 (データの配置の仕方) の種類の主要なものとして,
...
ちなみに, これらのデータ構造には階層構造があり, 行列や配列はベクトルの特別な場合, リストはベクトルの特別な場合, データフレームはリストの特別な場合である.
...
データフレームを使いこなすことが上達には欠かせない.

Rで分析を行う場合には, データや関数 (データ処理するための手続きを書いたコード) をオブジェクト (object) と呼ばれる"箱"に名前を付けて一旦格納し, その名前を呼び出す形で処理を実行するのが便利である.
...
```r
# 例えば, 
# data1 <- read.table("/Users/[アカウント名]/Desktop/BS_2022/data.txt", sep = ", ")
# または
# data1 <- read.csv("/Users/[アカウント名]/Desktop/BS_2022/data.txt", header = T, row.names = 1)

# 代替的に
# data2 <- scan("/Users/[アカウント名]/Desktop/BS_2022/data.txt", sep = ", ")
#matrix(scan("/Users/[アカウント名]/Desktop/BS_2022/data.txt", sep = ", "), 3, 4, byrow = T)
# matrix(scan("/Users/[アカウント名]/Desktop/BS_2022/data.txt", sep = ", "), 3, 4)
...
# b 2 3
# c 3 4
# data3 <- scan("/Users/[アカウント名]/Desktop/BS_2022/data.txt", sep = ", ", list(x = "", y = 0, z = 0))
# data.frame(data2)		# データフレーム化

# パスを指定せずに, テキストファイルの置かれているフォルダに移動してから
# ファイル名のみを使って読み込んでも良い
# setwd("/Users/[アカウント名]/Desktop/BS_2022")
...
```r
# 例えば, 
# write.table(data3, "/Users/[アカウント名]/Desktop/BS_2022/data3_out1.txt")
# write.table(data3, "/Users/[アカウント名]/Desktop/BS_2022/data3_out1.txt", append = T)
# write.csv()

# sink("/Users/[アカウント名]/Desktop/BS_2022/data3_out1.txt")
data1; data2
sink()
```
